...
test("Butonlara tıklanınca fonksiyonlar doğru parametreler ile çalışır", async () => {
  ...
  // prop olarak scoops bileşeninden gönderilen orjinal fonksiyonları gönderemeyeceğimizden fonksiyonlar doğru şekilde doğru zamanda doğru parametreler ile çalışıyor mu kontrolünü yapabilmek için asıl fonksiyonu taklit eden mock fonksiyonu tanımlamak gerekir
